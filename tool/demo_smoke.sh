...
echo "4) Open project card menu and try Copy JSON / Import Project JSON"
echo "5) Open Playback, verify controls + export feedback"
echo "6) Optional: follow docs/04-export-qa-checklist.md"
