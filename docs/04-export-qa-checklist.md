...
- Prije ručnog passa pokrenuti `./tool/release_smoke.sh` kao brzi automatski preflight za export/reliability/focus-preview regressions, uključujući deep long-scene focus-preview auto-follow u overlayu i embedded avatar retention u hero previewu (widget + export unit testovi)
